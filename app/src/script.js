  ...
  renderAlerts = () => {
    ...
    if (alerts) {
      alerts.forEach((a) => {
        ...
        dom.querySelector(
          'div[data-attrib="dates"]'
        ).innerText = `${start} - ${end}`;
        dom.querySelector('div[data-attrib="sender"]').innerText =
          a.sender_name;
        dom.querySelector('p[data-attrib="description"]').innerHTML =
          a.description;
        dom.querySelector('div[data-attrib="tags"]').innerHTML = a.tags.map(

...
(() => {
  ...
  const getDate = (unix_timestamp, timezone) => {
    return _momentTimezone.unix(unix_timestamp).tz(timezone);
  };
  ...
  const getDisplayText = (city, splitBy, includeFields = ["name", "state", "country"]) => {
    return includeFields.map(field => city[field]).filter(v => !!v).map(v => `<span>${v}</span>`).join(splitBy);
  };
...
},{"moment-timezone":"7uehh"}],"7uehh":[function(require,module,exports) {
var moment = module.exports = require("./moment-timezone");
moment.tz.load(require('./data/packed/latest.json'));

},{"./moment-timezone":"4tDTo","./data/packed/latest.json":"684yZ"}],"4tDTo":[function(require,module,exports) {
var define;
// ! moment-timezone.js
// ! version : 0.5.33
...
},{"moment":"5Hi32"}],"5Hi32":[function(require,module,exports) {
var define;
// ! moment.js
// ! version : 2.29.1
...
},{}],"684yZ":[function(require,module,exports) {
